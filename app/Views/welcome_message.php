...
<head>
    ...
    <link href="<?= base_url('asset/tailwind/node_modules/') ?>bootstrap-icons/bootstrap-icons.css" rel="stylesheet">


    <script src="<?= base_url('asset/tailwind/node_modules/') ?>tw-elements/dist/js/index.min.js"></script>
