<ul class="flex flex-col pl-0 mb-0" id="menu">
    <li class="card-menu">
        <a class="<?= $title == 'Dashboard' ? 'menu-item-active' : 'item-menu'; ?> " href="<?= base_url('/admin') ?>">
    ...
    <li class="card-menu">
        <a class="item-menu" href="<?= base_url('asset/soft-ui/build/') ?>/pages/rtl.html">
            <div class="card-icon-menu">
    ...
    <li class="card-menu">
        <a class="item-menu" href="<?= base_url('asset/soft-ui/build/') ?>/pages/profile.html">
            <div class="card-icon-menu">
