<ul class="flex flex-col pl-0 mb-0" id="menu">
    <li class="card-menu">
        <a class="menu-item-active" href="<?= base_url('asset/soft-ui/build/') ?>/pages/dashboard.html">
            <div class="bg-gradient-to-tl from-purple-700 to-pink-500 card-icon-menu">
    ...
    <li class="card-menu">
        <a class="item-menu" href="<?= base_url('asset/soft-ui/build/') ?>/pages/tables.html">
